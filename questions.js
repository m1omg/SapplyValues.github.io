questions = 
    [[//Left-Right`
        ...
        [//Liberty
            ...
            "Educating people so they can make better decisions for themselves is preferable to enforcing them by the state",
            ...
            "An individual’s body is their own property, and they should be able to do anything they desire to it and the same applies to their interactions with another consenting person.",
            "State schools and state owned media are a bad idea because the state can use them to push its own agenda"
        ]],[//Progressive-Conservative
        [//Progressive
            "The value of one's opinions on a given issue depends on their priviledge in society",
            "Members of disadvantaged groups that have previously suffered discrimination should be given advantages over the rest of the population to redress past wrongs done to them",
        ...
        [//Conservative
            ...
            "People should always follow traditional gender roles",
